...
@section('title', 'Chỉnh sửa Tiện ích - Ba Động Tourism')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Chỉnh sửa Tiện ích</li>
        </ol>
    </nav>
@endsection
...
@section('content')
    <div class="main-content">
        ...
        <div class="content">
            ...
            <form id="amenity-form" action="{{ route('admin.amenities.update', $entity) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon" name="icon" value="{{ old('icon', $entity->icon) }}" placeholder="Ví dụ: wifi, swimming-pool">
