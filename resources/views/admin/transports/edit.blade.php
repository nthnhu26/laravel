...
@section('title', 'Chỉnh sửa Phương tiện - Ba Động Tourism')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Chỉnh sửa Phương tiện</li>
        </ol>
    </nav>
@endsection
...
@section('content')
    <div class="main-content">
        ...
        <div class="content">
            ...
            <form id="transport-form" action="{{ route('admin.transports.update', $entity) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-container">
                    <div class="form-main">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('capacity') is-invalid @enderror" id="capacity" name="capacity" value="{{ old('capacity', $entity->capacity) }}" required>
                                            @error('capacity')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('price_per_day') is-invalid @enderror" id="price_per_day" name="price_per_day" value="{{ old('price_per_day', $entity->price_per_day) }}" required>
                                            @error('price_per_day')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                        ...
                        @include('admin.partials.image-upload', ['resourceName' => 'Phương tiện', 'entity' => $entity])
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" id="status" name="status">
                                        <option value="available" {{ old('status', $entity->status) == 'available' ? 'selected' : '' }}>Có sẵn</option>
                                        <option value="booked" {{ old('status', $entity->status) == 'booked' ? 'selected' : '' }}>Đã đặt</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
