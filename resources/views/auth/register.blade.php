...
<h1 class="text-center">@lang('signup')</h1>
<a href="{{ route('login') }}" class="close-btn text-decoration-none">&times;</a>
<form method="POST" action="{{ route('register') }}" id="registerForm">
    ...
    <div class="mb-3">
        ...
        <div class="input-group">
            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="@lang('enteryourname')" required>
            @error('name')
    ...
    <button type="submit" class="btn btn-primary w-100">@lang('signup')</button>
    <div class="text-center mt-3">
        <a href="{{ route('login') }}" class="text-decoration-none text-muted">@lang('signinnow')</a>
    </div>
</form>
